...
@endsection
        ...
        <div class="inline">
            <h1>mes annonces</h1>
            <a class="nvlannonce" href="{{ route('annonces.create', ['id' => $id, 'nom' => $nom, 'prenom' => $prenom]) }}" style="color: rgb(255, 255, 255);"><i class="fas fa-pen"></i> Nouvelle Annonce</a>
        </div>
            ...
            <div style="background-color: rgb(39, 140, 140); width: 50%; padding: 15px; margin: 10px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                ...
                <div style="display: flex; justify-content: space-between; margin-top: 15px;">
                    <a href="{{ route('annonces.modifier', ['id' => $annonce->id]) }}" style="text-decoration: none;">
