<x-ChefFiliere_layout :id="$id" :nom="$nom" :prenom="$prenom">
        ...
        <main>
            ...
            @endif
                ...
                <form action="/ChefFiliere/annonces" method="Get" class="form-container">
                    @csrf 
                    <div class="form-group">
                        <label for="type" class="form-label">Titre</label>
                        <input type="text" class="form-input" name="type" value="{{ old('type') }}"
                            placeholder="Exemple: arrêt des cours, planning des soutenances …" />
                         @error('type')
