...
<body>
        ...
        <nav id="navbar">
            ...
            @if(str_ends_with(Auth::user()->email, '@dlg.com'))
                <!-- Add another set of <ul> elements specific to delegue -->
                    <li><a href="/etudiant/delegue"><i id="dash" class="fa-solid fa-gauge"></i>&nbsp; Dashboard delegue</a></li>
                    <li><a href="/demande"><i class="fa-solid fa-file"></i>&nbsp; Demande</a></li>
                    <li><a href="/annonces"><i id="annan" class='bx bxs-megaphone'></i>Annoncesdelegue</a></li>
                <ul>
    ...
    <div class="container">
        ...
        <form action="{{ url('/demande/store') }}" method="post" class="form-container">
