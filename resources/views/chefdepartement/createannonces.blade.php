<x-chefdepartement_layout  :id="$id" :nom="$nom" :prenom="$prenom" >
    ...
    <main>
        ...
        @endif
            ...
            <form action="/chefdepartement/annonces" method="get" class="form-container">
               
                <div class="form-group">
                    <label for="type" class="form-label">Titre</label>
                    <input type="text" class="form-input" name="type" value="{{ old('titre') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="classe" value="{{ old('classe') }}" placeholder="en majuscule : exemple : AD,IDAI,SSD..." />
                   
                </div>
                
                <div class="form-group">
                    <label for="description" class="form-label">Description</label>
                    <textarea name="description" class="form-input" cols="30" rows="10"></textarea>
                </div>
                
                <button class="button-style" type="submit">Envoyer</button>
            </form>
        </div>
