    ...
    <header id="header">
        ...
        <nav id="navbar">
            <ul>
                ...
                @isset($id, $nom, $prenom)
                <li><a href="{{ route('ChefFiliere.welcome', ['id' => $id, 'nom' => $nom, 'prenom' => $prenom]) }}">
                    <i id="dash" class="fa-solid fa-gauge"></i>&nbsp; Dashboard
                </a></li>
           
            

                    <li><a href="{{ route('ChefFiliere.annonces', ['id' => $id, 'nom' => $nom, 'prenom' => $prenom]) }}"><i id="annan" class='bx bxs-megaphone'></i>&nbsp; Annonces</a></li>
                    <li><a href="{{ route('ChefFiliere.demandes', ['id' => $id, 'nom' => $nom, 'prenom' => $prenom]) }}"><i class="fa-solid fa-file"></i>&nbsp; Demandes</a></li>
                    <li><a href="{{ route('ChefFiliere.reclamations') }}">
